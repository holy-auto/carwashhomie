          ...
          >
            ...
            <div className="flex flex-wrap gap-3 mt-8">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-6 py-3 rounded-full border-2 border-sunset text-sunset font-bold hover:bg-sunset hover:text-midnight transition-all"
              >
